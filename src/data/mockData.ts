...
export const mockRanking: { power: RankEntry[]; points: RankEntry[]; contribution: RankEntry[] } = {
  power: [
    { rank: 1, id: 'l1', name: '龙炎帝国', value: 584200, previousRank: 1, change: 0, metadata: { members: 48, tier: 'master' as RankTier, emblem: '🔥' } },
    { rank: 2, id: 'l2', name: '星辰圣殿', value: 512800, previousRank: 3, change: 1, metadata: { members: 52, tier: 'master' as RankTier, emblem: '⭐' } },
    { rank: 3, id: 'l3', name: '深渊军团', value: 489600, previousRank: 2, change: -1, metadata: { members: 45, tier: 'master' as RankTier, emblem: '💀' } },
    { rank: 4, id: 'l4', name: '雷霆之锤', value: 425300, previousRank: 4, change: 0, metadata: { members: 38, tier: 'diamond' as RankTier, emblem: '⚡' } },
    { rank: 5, id: 'legion-001', name: '暗影龙骑士团', value: 284650, previousRank: 7, change: 2, metadata: { members: 8, tier: 'platinum' as RankTier, emblem: '🐉' } },
    { rank: 6, id: 'l6', name: '北方守望者', value: 268900, previousRank: 5, change: -1, metadata: { members: 32, tier: 'platinum' as RankTier, emblem: '❄️' } },
    { rank: 7, id: 'l7', name: '翡翠林地', value: 245100, previousRank: 6, change: -1, metadata: { members: 28, tier: 'platinum' as RankTier, emblem: '🌿' } },
    { rank: 8, id: 'l8', name: '黄金之手', value: 212800, previousRank: 10, change: 2, metadata: { members: 25, tier: 'gold' as RankTier, emblem: '💰' } },
    { rank: 9, id: 'l9', name: '铁血兄弟会', value: 198500, previousRank: 8, change: -1, metadata: { members: 20, tier: 'gold' as RankTier, emblem: '🛡️' } },
    { rank: 10, id: 'l10', name: '紫焰法师塔', value: 187200, previousRank: 9, change: -1, metadata: { members: 15, tier: 'gold' as RankTier, emblem: '🔮' } },
  ],
  points: [
    { rank: 1, id: 'p1', name: '龙炎帝国', value: 28450, previousRank: 1, change: 0, metadata: { wins: 87, tier: 'master' as RankTier, emblem: '🔥' } },
    { rank: 2, id: 'legion-001', name: '暗影龙骑士团', value: 24890, previousRank: 4, change: 2, metadata: { wins: 72, tier: 'platinum' as RankTier, emblem: '🐉' } },
    { rank: 3, id: 'p3', name: '星辰圣殿', value: 23640, previousRank: 2, change: -1, metadata: { wins: 68, tier: 'master' as RankTier, emblem: '⭐' } },
    { rank: 4, id: 'p4', name: '深渊军团', value: 21250, previousRank: 3, change: -1, metadata: { wins: 65, tier: 'master' as RankTier, emblem: '💀' } },
    { rank: 5, id: 'p5', name: '雷霆之锤', value: 18720, previousRank: 5, change: 0, metadata: { wins: 58, tier: 'diamond' as RankTier, emblem: '⚡' } },
  ],
  contribution: [
    { rank: 1, id: 'c1', name: '星辰圣殿', value: 156800, previousRank: 2, change: 1, metadata: { research: 12, emblem: '⭐' } },
    { rank: 2, id: 'c2', name: '龙炎帝国', value: 148200, previousRank: 1, change: -1, metadata: { research: 15, emblem: '🔥' } },
    { rank: 3, id: 'legion-001', name: '暗影龙骑士团', value: 98560, previousRank: 3, change: 0, metadata: { research: 5, emblem: '🐉' } },
    { rank: 4, id: 'c4', name: '深渊军团', value: 87300, previousRank: 4, change: 0, metadata: { research: 8, emblem: '💀' } },
    { rank: 5, id: 'c5', name: '黄金之手', value: 76450, previousRank: 6, change: 1, metadata: { research: 6, emblem: '💰' } },
  ],
};
